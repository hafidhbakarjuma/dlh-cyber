...
*   **STRONG**: F1 >= 0.70 (High confidence, balanced precision and recall).
...
## Risk Ranking Model
Catalog priority is calculated via risk-based weighting: Priority Score = Sum of (Likelihood * Impact) * F1. Rules with an F1 score of zero are assigned a safety floor of Risk Score * 0.1. Unmatched rules are classified as ORPHAN.
...
* [ ] F1 >= 0.70 verified against ground truth.
